export default {
  ...
  'module.customer.manualRecycle': '立即回收客户',
  'module.customer.manualRecycleConfirm': '确定要立即回收公海 {name} 的客户吗？',
  'module.customer.manualRecycleSuccess': '回收完成，共回收 {count} 个客户',
  'module.customer.manualRecycleFailed': '回收失败，请稍后重试',
  ...
  'module.clue.contractStartTime': '合同开始时间',
  'module.clue.contractDays': '有合同天数',
  'module.clue.noContractDays': '无合同天数',
  'module.clue.dailyViewLimit': '每日可看',
  'module.clue.dailyViewCount': '可看数量',
  'module.clue.monthlyViewLimit': '每月可看',
  'module.clue.monthlyViewCount': '每月可看数量',
  'module.clue.viewLimitMutualExclusion': '每日可看与每月可看互斥，只能选择其中一个启用',
  'module.clue.viewAllocationHint': '当前周期已分配 {allocated}/{limit} 家客户{insufficient}',
  'module.clue.monthlyPickLimit': '每月领取',
  'module.clue.monthlyPickCount': '每月领取数量',
