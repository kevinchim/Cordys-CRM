export default {
  ...
  'module.clue.contractStartTime': 'Contract start time',
  'module.clue.contractDays': 'Days with contract',
  'module.clue.noContractDays': 'Days without contract',
  'module.clue.dailyViewLimit': 'Daily viewable',
  'module.clue.dailyViewCount': 'Viewable count',
  'module.clue.monthlyViewLimit': 'Monthly viewable',
  'module.clue.monthlyViewCount': 'Monthly viewable count',
  'module.clue.viewLimitMutualExclusion':
    'Daily view and monthly view limits are mutually exclusive. Only one can be enabled.',
  'module.clue.viewAllocationHint': '{allocated}/{limit} accounts allocated for current period{insufficient}',
  'module.clue.monthlyPickLimit': 'Monthly collection',
  'module.clue.monthlyPickCount': 'Monthly collection count',
  ...
  'module.customer.manualRecycle': 'Recycle Now',
  'module.customer.manualRecycleConfirm': 'Are you sure you want to immediately recycle accounts in pool {name}?',
  'module.customer.manualRecycleSuccess': 'Recycle completed, {count} accounts recycled',
  'module.customer.manualRecycleFailed': 'Recycle failed, please try again later',
